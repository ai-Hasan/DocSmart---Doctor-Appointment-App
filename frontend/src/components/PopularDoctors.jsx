...
const PopularDoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10 ">
      <h1 className="text-3xl font-medium">Popular Doctors to Book</h1>
      ...
      <button
        ...
        className=" border border-[#2D9CDB] text-black font-medium hover:bg-[#2D9CDB] hover:text-white shadow-lg px-8 py-3 rounded-lg mt-8 text-sm md:px-12 lg:px-24 "
      >
        Check More
      </button>
    </div>
